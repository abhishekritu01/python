...
// const arr1 = [1, 2, 3];
// const arr2 = [4, 5, 6];
// const arrConcat = arr2.concat(arr1);
// console.log(arrConcat); // [1, 2, 3, 4, 5, 6]
// console.log(arrConcat.length); // [1, 2, 3]
...
// const arrFlat = [1, [2, [3,4,5]], [4, [5]]].flat(2);
...
// console.log(typeof arrJoin); // string
...
// const arrReduce = [1, 2, 3, 5].reduce((acc, x) => acc + x);
...
// const arrSlice = [1, 2, 3, 4].slice(0,3);
